...
public class ScrollArea extends AbstractWidget {
    ...
    private final List<LateRenderable> lateChildren = new ArrayList<>();
    ...
    public void addLateRenderable(LateRenderable renderable) { lateChildren.add(renderable); }
    ...
    protected void renderWidget(@NonNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        lateChildren.forEach(children -> {
            ((AWScrollArea) children).enableScrollArea(scrollIndex);
            children.lateRender(graphics, mouseX, mouseY - scrollIndex, partialTick);
        });
