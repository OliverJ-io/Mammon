...
import io.oliverj.mammon.utils.MathUtils;
...
public class PopupMenu {
    ...
    private static final Identifier BACKGROUND = Mammon.id("textures/gui/popup.png");
    private static final Identifier ICONS = Mammon.id("textures/gui/popup_icons.png");
    ...
    public static void render(GuiGraphics gui) {
        ...
        int frame = (int) ((MammonClient.ticks / 5f) % 4);
