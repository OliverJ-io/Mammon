...
public class EconToast implements Toast {
    ...
    public void render(GuiGraphics gui, @NonNull Font font, long visibilityTime) {
        ...
        int frame = (int) ((MammonClient.ticks / 5f) % type.frames);
    ...
    public enum ToastType {
        DEFAULT(Mammon.id("textures/gui/toast/default.png"), 4, 160, 31, 0x55ffff),
        WARNING(Mammon.id("textures/gui/toast/warning.png"), 4, 160, 31, 0xffff00),
        ERROR(Mammon.id("textures/gui/toast/error.png"), 4, 160, 31, 0xff0000);
