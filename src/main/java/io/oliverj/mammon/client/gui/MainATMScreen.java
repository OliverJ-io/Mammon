...
public class MainATMScreen extends Screen {
    ...
    public void init() {
        ...
        List<TransactionWidget> widgets = new ArrayList<>();
        ...
        for (Transaction transaction : menu.getSelectedAccount().getTransactions()) {
            ...
            widgets.add(new TransactionWidget(
                    x, y + yOffset,
        ...
        widgets.forEach(area::addRenderableWidget);
        widgets.forEach(area::addLateRenderable);
