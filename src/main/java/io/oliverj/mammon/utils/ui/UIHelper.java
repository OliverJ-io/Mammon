package io.oliverj.mammon.utils.ui;
...
import io.oliverj.mammon.mixin.client.font.FontAccessor;
import io.oliverj.mammon.mixin.client.gui.GuiGraphicsAccessor;
import io.oliverj.mammon.utils.TextUtils;
...
public final class UIHelper {
    ...
    public static final Identifier OUTLINE_FILL = Mammon.id("textures/gui/outline_fill.png");
    public static final Identifier OUTLINE = Mammon.id("textures/gui/outline.png");
    public static final Identifier TOOLTIP = Mammon.id("textures/gui/tooltip.png");
    public static final FontDescription UI_FONT = new FontDescription.Resource(Mammon.id("ui"));
    public static final FontDescription SPECIAL_FONT = new FontDescription.Resource(Mammon.id("special"));
    ...
    public static void renderAnimatedBackground(GuiGraphics gui, Identifier texture, float x, float y, float width, float height, float textureWidth, float textureHeight, double speed, float delta) {
        if (speed != 0) {
            double d = (MammonClient.ticks + delta) * speed;
            x -= d % textureWidth;
            y -= d % textureHeight;
        }
    ...
    private static int getTextScrollingOffset(int textWidth, int width, boolean centered) {
        ...
        int ticks = (int) (MammonClient.ticks * speed);
